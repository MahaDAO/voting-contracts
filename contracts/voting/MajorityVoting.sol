...
import '../interfaces/IMajorityVoting.sol';
import '../core/Component.sol';
...
abstract contract MajorityVoting is IMajorityVoting, Component, TimeHelpers {
  ...
  function newVote(
    ...
    VoterState _choice
  ) external virtual override returns (uint256 voteId);
  ...
  /// @inheritdoc IMajorityVoting
  function canVote(uint256 _voteId, address _voter) public view override returns (bool) {
    return _canVote(_voteId, _voter);
  }

  /// @inheritdoc IMajorityVoting
  function canExecute(uint256 _voteId) public view override returns (bool) {
